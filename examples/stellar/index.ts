...
const inputFile = path.relative('./', path.join(__dirname, '../../node_modules/@stellar/design-system/build/styles.min.css'));
const outputFile = './output/stellar-design-tokens.json';
...
async function main() {
    try {
        ...
        console.log(`🔍 Analyzing Stellar CSS file: ${inputFile}`);
        ...
        console.log(`\n✅ Successfully extracted Stellar design tokens!`);
    } catch (error) {
